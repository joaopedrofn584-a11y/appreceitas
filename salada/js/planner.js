            ...
            <div class="mt-3 pt-2.5 border-t border-emerald-900/60 flex items-center justify-between">
              <div class="flex items-center gap-2 overflow-hidden">
                <img 
                  ...
                  class="w-8 h-8 object-cover rounded-lg border border-emerald-700/50 flex-shrink-0"
                >
              ...
              <button 
                ...
                class="text-[10px] bg-emerald-800/60 hover:bg-emerald-700 text-emerald-200 px-2 py-1 rounded transition-colors flex-shrink-0 cursor-pointer"
              >
                Ver
              </button>
            </div>
